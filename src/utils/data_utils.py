"""Data loading utilities for BioASQ and MedQuAD"""
...
def load_ds(dataset_name, seed, add_options=None):
    """Load dataset for medical QA: BioASQ and MedQuAD.

    Args:
        dataset_name (str): Name of the dataset ("bioasq", "medquad").
    ...
    if dataset_name.lower() == "bioasq":
        ...
        path = "data/medquad/medquad_processed_gemini_persistent_filtered.csv"
